...
<body>
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                       value="{{ old('email') }}" placeholder="tucorreo@email.com" required>
            </div>
            <div class="mb-3">
        ...
        <p class="text-center text-muted mb-1" style="font-size:13px">
            ¿No tenés cuenta?
            <a href="{{ route('register') }}" style="color:#000;font-weight:700;text-decoration:none">Registrate</a>
        </p>
        <p class="text-center" style="font-size:13px">
            ¿Sos dueño de cancha?
            <a href="{{ route('register.owner') }}" style="color:#6C63FF;font-weight:700;text-decoration:none">Registrá tu sede →</a>
        </p>
    </div>
</body>
</html>
