...
<head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('title', 'SuperCancha Owner'); ?></title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('owner.dashboard')); ?>" class="nav-link-item <?php echo e(request()->routeIs('owner.dashboard') ? 'active' : ''); ?>">
            <i class="fa-solid fa-chart-pie"></i> Dashboard
        </a>

        <div class="sidebar-label">Gestión</div>
        <a href="<?php echo e(route('owner.venues.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('owner.venues.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-building"></i> Mis Sedes
        </a>
        <a href="<?php echo e(route('owner.courts.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('owner.courts.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-futbol"></i> Canchas
        </a>
        <a href="<?php echo e(route('owner.reservations.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('owner.reservations.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-calendar-check"></i> Reservas
        </a>

        <div class="sidebar-label">Cuenta</div>
        <a href="<?php echo e(route('owner.subscription.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('owner.subscription.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <div class="d-flex align-items-center gap-3">
            <?php if(auth()->user()->avatar): ?>
                <img src="<?php echo e(auth()->user()->avatar); ?>" class="rounded-circle" width="36" height="36">
            <?php else: ?>
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <?php if($sub?->isActive()): ?>
                <span class="badge" style="background:#e8f5e9;color:#2e7d32;border-radius:20px;padding:6px 12px;font-size:12px;">
                    ...
                    Plan <?php echo e($sub->plan?->name); ?> · vence <?php echo e($sub->ends_at?->format('d/m/Y')); ?>

                </span>
            <?php else: ?>
                <a href="<?php echo e(route('owner.subscription.index')); ?>" class="badge text-decoration-none" style="background:#fff3e0;color:#e65100;border-radius:20px;padding:6px 12px;font-size:12px;">
    ...
    <main class="page-content">
        ...
        <?php if(session('warning')): ?>
            <div class="alert border-0 mb-4" style="background:#fff3e0;color:#e65100;border-radius:14px;">
                <i class="fa-solid fa-triangle-exclamation me-2"></i><?php echo e(session('warning')); ?>
...
<?php /**PATH /Users/erickperezrayo/Documents/canchascr/resources/views/layouts/owner.blade.php ENDPATH**/ ?>