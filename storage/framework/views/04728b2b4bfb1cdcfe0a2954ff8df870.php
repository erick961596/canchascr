...
<head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('title', 'Admin - SuperCancha'); ?></title>
...
<aside class="sidebar">
    ...
    <nav style="flex:1;padding:12px 0">
        ...
        <a href="<?php echo e(route('admin.venues.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.venues.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-building"></i> Sedes
        </a>
        <a href="<?php echo e(route('admin.plans.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.plans.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-layer-group"></i> Planes
        </a>
        <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-crown"></i> Suscripciones
        </a>
        <a href="<?php echo e(route('admin.logs.index')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.logs.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-terminal"></i> Logs del sistema
        </a>
        <a href="<?php echo e(route('admin.subscriptions.pending')); ?>" class="nav-link-item <?php echo e(request()->routeIs('admin.subscriptions.pending') ? 'active' : ''); ?>">
            <i class="fa-solid fa-clock"></i> Pagos pendientes
            <?php $pendingCount = \App\Models\SubscriptionPayment::where('status','pending')->where('method','manual')->count(); ?>
            <?php if($pendingCount > 0): ?>
            <span class="ms-auto badge" style="background:#ff5252;color:#fff;border-radius:20px;font-size:10px;padding:2px 7px"><?php echo e($pendingCount); ?></span>
            <?php endif; ?>
        </a>
    </nav>
    <div class="sidebar-footer">
        <div style="color:#888;font-size:12px;margin-bottom:8px">
            <i class="fa-solid fa-circle-user me-1"></i><?php echo e(auth()->user()->name); ?>
...
<div class="main-wrapper">
    <header class="topbar">
        <h6 class="mb-0 fw-700"><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?></h6>
...
<?php /**PATH /Users/erickperezrayo/Documents/canchascr/resources/views/layouts/admin.blade.php ENDPATH**/ ?>