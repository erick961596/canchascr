...
<?php $__env->startSection('page_title', 'Planes de suscripción'); ?>
...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        ...
        <div class="stat-card position-relative <?php echo e(!$plan->active ? 'opacity-50' : ''); ?>"
             data-plan-id="<?php echo e($plan->id); ?>"
             data-plan-name="<?php echo e($plan->name); ?>"
             data-plan-desc="<?php echo e($plan->description); ?>"
             data-plan-price="<?php echo e($plan->price); ?>"
             data-plan-courts="<?php echo e($plan->court_limit); ?>"
             data-plan-priceid="<?php echo e($plan->onvopay_price_id ?? $plan->onvopay_id); ?>"
             data-plan-active="<?php echo e($plan->active ? '1' : '0'); ?>">

            <div class="d-flex align-items-start justify-content-between mb-3">
                <div>
                    <h5 class="fw-800 mb-0"><?php echo e($plan->name); ?></h5>
                    <div class="text-muted" style="font-size:12px;margin-top:2px"><?php echo e($plan->description); ?></div>
                </div>
                <span style="<?php echo e($plan->active ? 'background:#e8f5e9;color:#2e7d32' : 'background:#f5f5f5;color:#888'); ?>;border-radius:20px;font-size:11px;padding:4px 10px;white-space:nowrap;flex-shrink:0">
                    <?php echo e($plan->active ? '● Activo' : '○ Inactivo'); ?>

                </span>
            </div>

            <div class="fw-800 mb-3" style="font-size:32px;letter-spacing:-1px">
                ₡<?php echo e(number_format($plan->price,0,',','.')); ?><span class="text-muted fw-400" style="font-size:13px">/mes</span>
            </div>

            <div class="d-flex gap-3 mb-4" style="font-size:13px">
                <span><i class="fa-solid fa-futbol me-1 text-muted"></i><strong><?php echo e($plan->court_limit); ?></strong> canchas</span>
                <span><i class="fa-solid fa-users me-1 text-muted"></i><strong><?php echo e($plan->subscriptions_count); ?></strong> suscriptores</span>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-sm btn-toggle-plan"
                        ...
                        title="<?php echo e($plan->active ? 'Desactivar' : 'Activar'); ?>">
                    <i class="fa-solid <?php echo e($plan->active ? 'fa-eye-slash' : 'fa-eye'); ?>"></i>
                </button>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/erickperezrayo/Documents/canchascr/resources/views/pages/admin/plans/index.blade.php ENDPATH**/ ?>