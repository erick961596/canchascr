<?php $__env->startSection('title', 'Suscripción'); ?>
<?php $__env->startSection('page_title', 'Mi suscripción'); ?>
...
<?php if($subscription): ?>
    ...
    <div class="d-flex align-items-center gap-3 p-4 rounded-3 mb-4" style="background:#e8f5e9;border:1.5px solid #a5d6a7">
        ...
        <div>
            ...
            <span class="text-muted ms-2" style="font-size:13px">Plan <?php echo e($subscription->plan?->name); ?>

                <?php if($subscription->ends_at): ?> · vence <?php echo e($subscription->ends_at->format('d/m/Y')); ?> <?php endif; ?>
            </span>
        </div>
    </div>
...
<div class="row g-4">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" id="plan_select" style="border-radius:12px;border:1.5px solid #e0e0e0;font-weight:600">
                    ...
                    <option value="<?php echo e($plan->id); ?>"
                        ...
                        data-court-limit="<?php echo e($plan->court_limit); ?>"
                        <?php if(request('plan_id') == $plan->id || $loop->first): echo 'selected'; endif; ?>>
                        <?php echo e($plan->name); ?> — ₡<?php echo e(number_format($plan->price,0,',','.')); ?>/mes
                    </option>
    ...
    <div class="col-lg-8">
        <div class="stat-card">
            ...
            <form id="subscription_form" action="<?php echo e(route('owner.subscription.create')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div id="sinpe_form_wrapper" class="d-none">
                        <div class="p-4 rounded-3 mb-4" style="background:#e8f5e9;border:1.5px dashed #a5d6a7">
                            ...
                            <p class="mb-1 text-muted" style="font-size:13px">
                                Realizá el pago al número <strong><?php echo e(config('app.sinpe_number', '8888-8888')); ?></strong><br>
                                Concepto: <strong>SuperCancha — <?php echo e(auth()->user()->email); ?></strong>
                            </p>
                        </div>
...
document.getElementById('sinpe_file').addEventListener('change', async function () {
    ...
    try {
        const res = await axios.post('<?php echo e(route("owner.subscription.upload")); ?>', fd, {
...
// ── Submit ─────────────────────────────────────────────────────
const onvoClient = typeof ONVO !== 'undefined' ? ONVO("<?php echo e(config('services.onvopay.public')); ?>") : null;
const DASHBOARD_URL = "<?php echo e(route('owner.dashboard')); ?>";
...
<?php echo $__env->make('layouts.owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/erickperezrayo/Documents/canchascr/resources/views/pages/owner/subscription/index.blade.php ENDPATH**/ ?>